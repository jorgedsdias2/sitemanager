= Gerenciador de sites {<img src="https://codeclimate.com/github/jorgedsdias/sitemanager/badges/gpa.svg" />}[https://codeclimate.com/github/jorgedsdias/sitemanager]
...
RSpec 3.4.4
  rspec -f d spec/{folder}/{arquivo}_spec.rb
